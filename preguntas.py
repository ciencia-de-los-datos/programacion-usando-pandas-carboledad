...
def pregunta_12():
    ...
    tbl2['_c5b'] = tbl2['_c5b'].map(lambda x: str(x))
...
def pregunta_13():
    ...
    """
    df1 = pd.read_csv('tbl0.tsv', delimiter='\t', header=0)
    df2 = pd.read_csv('tbl2.tsv', delimiter='\t', header=0)
